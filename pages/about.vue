        ...
        <div class="py-24 bg-zinc-950 sm:py-32">
            <div class="px-6 mx-auto max-w-7xl lg:px-8">
                <div
                    ...
                    <div class="lg:pr-4">
                        <!-- <img class="absolute inset-0 object-cover w-full h-full brightness-125 saturate-0"
                        ...
                        <!-- <div class="absolute inset-0 bg-gray-900 mix-blend-multiply" />
                            <div class="absolute -ml-16 -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2 transform-gpu blur-3xl"
                                aria-hidden="true">
                            ...
                            <figure class="relative isolate">
                                <svg viewBox="0 0 162 128" fill="none" aria-hidden="true"
                                    class="absolute h-32 -left-2 -top-4 -z-10 stroke-white/20">
                                ...
                                <blockquote class="mt-6 text-xl font-semibold leading-8 text-white">
                                    <p>“Amet amet eget scelerisque tellus sit neque faucibus non eleifend. Integer eu
                                        praesent
                                        at a. Ornare arcu gravida natoque erat et cursus tortor.”</p>
                                </blockquote>
                    ...
                    <div>
                        <div class="text-base leading-7 text-gray-200 lg:max-w-lg">
                            <h1 class="text-5xl font-bold tracking-tight text-gray-100 sm:text-6xl">
                                Bakit puro lait
                            </h1>
                            <h2 class="text-3xl font-bold tracking-tight text-gray-100 sm:text-4xl">
                                ang laman ng page mo?
                            </h2>
                            <!-- <p class="text-base leading-7 text-gray-600 fnt-thin">Directed by: {{ data.director }}</p> -->
                            <div class="max-w-xl">
                        ...
                        <!-- <dl class="grid grid-cols-2 gap-8 pt-10 mt-10 border-t border-gray-900/10 sm:grid-cols-4">
                            <div v-for="(stat, statIdx) in stats" :key="statIdx">
                                ...
                                <dd class="mt-2 text-3xl font-bold leading-10 tracking-tight text-gray-900">{{ stat.value }}
                                </dd>
                            </div>
                        </dl> -->
